...
const bot = initialBots.find((b: Bot) => b.id === params.id)
...
<template>
  <div class="rounded-lg w-full mx-4 overflow-hidden">
    <div v-if="bot">
    ...
    <div v-else class="flex flex-col gap-y-4">
      Bot não encontrado.
      <button
        class="px-6 py-2 bg-primary/60 text-white rounded-lg hover:bg-gray-600 transition w-48"
        @click="goBack"
      >
        Voltar
      </button>
